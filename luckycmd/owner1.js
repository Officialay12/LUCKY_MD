...
const date = moment().format('DD/MM/YYYY');
  ...
  let infoMsg =  `> Hello ${nomAuteurMessage} you requested for my deployer😌\n *${s.OWNER_NAME}* is my Charming good looking deployer and also the architect🍂💋.\n\n> Powered by Ayo Tech `;

   var lien = mybotpic();

   if (lien.match(/\.(mp4|gif)$/i)) {
    try {
        zk.sendMessage(dest, { video: { url: lien }, caption:infoMsg + menuMsg, footer: "Je suis *Sung Md*, déveloper Ayo-codes" , gifPlayback : true }, { quoted: ms });
    }
    catch (e) {
